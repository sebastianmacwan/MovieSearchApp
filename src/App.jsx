      ...
      <footer className="bg-gray-100 dark:bg-gray-800 text-center py-6 mt-10 text-sm text-gray-600 dark:text-gray-300">
        <div className="max-w-4xl mx-auto px-4 flex flex-col sm:flex-row justify-between items-center gap-3">
          ...
          <div className="flex gap-4 text-lg">
            <a href="https://github.com/sebastianmacwan" target="_blank" rel="noreferrer" className="hover:text-blue-500">🐱 GitHub</a>
            <a href="https://www.pureconnectt.com/" target="_blank" rel="noreferrer" className="hover:text-blue-400">🐦 company</a>
            <a href="https://www.linkedin.com/in/sebastian-macwan" target="_blank" rel="noreferrer" className="hover:text-blue-600">💼 LinkedIn</a>
          </div>
        </div>
